(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('ng-zorro-antd/core/logger'), require('rxjs'), require('@angular/common'), require('date-fns/format'), require('date-fns/getISOWeek'), require('date-fns/parse'), require('ng-zorro-antd/core/time')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/i18n', ['@angular/core','exports', '@angular/core', 'ng-zorro-antd/core/logger', 'rxjs', '@angular/common', 'date-fns/format', 'date-fns/getISOWeek', 'date-fns/parse', 'ng-zorro-antd/core/time'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,(global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].i18n = {}), global.ng.core, global['ng-zorro-antd'].core.logger, global.rxjs, global.ng.common, global.fnsFormat, global.fnsGetISOWeek, global.fnsParse, global['ng-zorro-antd'].core.time));
}(this, (function (ɵngcc0,exports, i0, logger, rxjs, common, fnsFormat, fnsGetISOWeek, fnsParse, time) { 'use strict';
